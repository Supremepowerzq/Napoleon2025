...
class UnetPackage:
    ...
    def render_isometric_point_cloud(self, depth_m, depth_color, contours2, max_num, cx, cy,
        ...
        cv2.putText(view, 'X', (x_end_x + 3, x_end_y + 8), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 0, 255), 1, cv2.LINE_AA)
        ...
        cv2.putText(view, 'Z', (z_end_x + 3, z_end_y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 0, 0), 1, cv2.LINE_AA)
