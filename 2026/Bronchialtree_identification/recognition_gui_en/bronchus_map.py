...
DISPLAY_NAMES = {
    ...
    "RULB": "Right Upper Lobe",
    "BI": "Bronchus Intermedius",
    "RMLB": "Right Middle Lobe",
    "RLLB": "Right Lower Lobe",
    "LMB": "Left Main Bronchus",
    "LULB": "Left Upper Lobe",
    "LLLB": "Left Lower Lobe",
}
...
class BronchusMapWidget(QWidget):
    def __init__(self, asset_path: Path, parent: Optional[QWidget] = None) -> None:
        ...
        self._empty_message = "Object detection is off"
    ...
    def set_detection_state(
        ...
        safe_state: str,
        empty_message: str = "Waiting for recognition",
    ) -> None:
    ...
    def paintEvent(self, _event) -> None:  # noqa: N802 - Qt API
        ...
        painter.drawText(
            ...
            Qt.AlignLeft | Qt.AlignVCenter,
            "Confirmed anatomy after motion-aware validation",
        )
        ...
        if self._confirmed:
            ...
            painter.drawText(
                footer,
                Qt.AlignCenter,
                f"Current position: {current_name}  [{self._confirmed}]",
            )
        else:
    ...
    def _draw_label(painter: QPainter, name: str, point: QPointF, active: bool) -> None:
        ...
        painter.setFont(QFont("Segoe UI", 8, QFont.Bold if active else QFont.Normal))
