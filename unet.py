...
class Unet(object):
    _defaults = {
        ...
        "model_path"    : 'E:/zq/TJU/DLCatheter/Napoleon6.21/DLpredict/logs/(biom)best_epoch_weights.pth',#实验室肾模型用
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 21:
            self.colors = [ (0, 0, 0), (0, 160, 255), (0, 255, 255), (128, 128, 0), (0, 0, 128), (128, 0, 128), (0, 128, 128), 
